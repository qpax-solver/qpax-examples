...
| [`autotuning_mpc`](examples/autotuning_mpc/)<br><img src="docs/learned_mpc_anim.gif" width="220"> | MPC autotuning from demonstrations | Learns MPC cost weights from demonstration trajectories. | [Adabag et al.](https://arxiv.org/abs/2510.06179)|
